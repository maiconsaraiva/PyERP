...
from ..views.wparameter import (
    DeleteWParameter , WParameterCreateView, WParameterDetailView, WParameterListView, WParameterUpdateView)
...
urlpatterns = [
    ...
    path('wparameter/<int:pk>/delete/', DeleteWParameter, name='wparameter-delete'),
]